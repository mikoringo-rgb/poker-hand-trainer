...
export default function PlayingCard({
  ...
  const sizeClasses = {
    xs: 'w-7 h-7 p-0.5',
    sm: 'w-9 h-9 p-1',
    compact: 'w-[clamp(42px,11vw,56px)] h-[clamp(48px,7.2dvh,62px)] p-1',
  ...
  const textSizes = {
    ...
    compact: { rank: 'text-[clamp(16px,4.6vw,22px)]', suit: 'text-[clamp(18px,5vw,24px)]' },
